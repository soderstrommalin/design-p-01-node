...
describe("Test DELETE /api/products/:id", () => {
    test("Test trying to delete exsisting product", async () => {
        const res = await request.delete(`/api/products/152164826489`);
        expect(res.status).toBe(200);
    });
    test("Test trying to delete none exsisting product", async () => {
